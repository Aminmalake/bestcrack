...
def chk(): 
  ...
  print("\n\n\x1b[37;1mYour ID : "+id) 
  try: 
    httpCaht = requests.get("https://raw.githubusercontent.com/Aminmalake/bestcrack/main/list.txt").text 
    if id in httpCaht: 
      ...
      print("\x1b[91mId Active nya Bo Active Krdn Nrxi Am Toola 5$ Nama Bnera la telegrm@amin_malake\033[97m") 
...
def menu():
    ...
    print("   Auther: kurdo\n   INSTAGRAM: @amin_malake\n   Telegram : @amin_malake\n")
    print ("\033[1;97m=============================================================== ")
 
 
 
    print '\x1b[1;92m[1]\x1b[1;92m Crack Number KURD VIP'
